...
public class CourseUserController {
    ...
    ResponseEntity<Page<UserDto>> getAllUsersByCourse(@PageableDefault(sort = "userId", direction = Sort.Direction.ASC, size = 10)
                                                        Pageable pageable,
    ...
    public ResponseEntity<Object> saveSubscriptionUserInCourse(@PathVariable("courseId") UUID courseId,
        ...
        if (courseModel.isPresent()) {
            ...
            CourseUserModel courseUserModel = courseUserService.saveAndSendSubscriptionUserInCourse(courseModel.get().convertToUserModel(subscriptionDto.getUserId()));
